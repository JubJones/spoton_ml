#!/usr/bin/env python3
"""
Phase 2 Re-ID Analysis Runner

This script runs the Phase 2 Re-ID analysis pipeline which:
...
Usage:
    python src/run_phase2_reid_analysis.py [--config CONFIG_PATH] [--device DEVICE]

Example:
    python src/run_phase2_reid_analysis.py --config configs/phase2_reid_analysis_config.yaml --device cuda:0
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Run Phase 2 Re-ID Analysis",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
    # Run with default configuration
    python src/run_phase2_reid_analysis.py
    
    # Run with custom configuration
    python src/run_phase2_reid_analysis.py --config configs/phase2_reid_analysis_config.yaml
    
    # Run with specific device
    python src/run_phase2_reid_analysis.py --device cuda:0
    
    # Run with CPU only
    python src/run_phase2_reid_analysis.py --device cpu
        """
    )
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="configs/phase2_reid_analysis_config.yaml",
        help="Path to configuration file (default: configs/phase2_reid_analysis_config.yaml)"
    )
